...
def wxyz2xyzw(quat):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import wxyz2xyzw
    >>> wxyz2xyzw([1, 2, 3, 4])
    array([2, 3, 4, 1])
    """
...
def xyzw2wxyz(quat):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import xyzw2wxyz
    >>> xyzw2wxyz([1, 2, 3, 4])
    array([4, 1, 2, 3])
    """
    if isinstance(quat, list):
...
def triple_product(a, b, c):
    ...
    Examples
    --------
    >>> from magrobot.math import triple_product
...
def midpoint(p, a, b):
    ...
    --------
    >>> import numpy as np
    >>> from magrobot.coordinates.math import midpoint
...
def midrot(p, r1, r2):
    ...
    --------
    >>> import numpy as np
    >>> from magrobot.coordinates.math import midrot
    >>> midrot(0.5,
            np.eye(3),
...
def rotate_vector(vec, theta, axis):
    ...
    >>> from magrobot.coordinates.math import rotate_vector
...
def matrix_exponent(omega, p=1.0):
    ...
    --------
    >>> import numpy as np
    >>> from magrobot.coordinates.math import matrix_exponent
...
def outer_product_matrix(v):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import outer_product_matrix
...
def quaternion2rpy(q):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import quaternion2rpy
...
def rotation_matrix_from_rpy(rpy):
    ...
    --------
    >>> import numpy as np
    >>> from magrobot.coordinates.math import rotation_matrix_from_rpy
...
def rotation_matrix_from_axis(
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import rotation_matrix_from_axis
...
def rodrigues(axis, theta=None):
    ...
    --------
    >>> import numpy
    >>> from magrobot.coordinates.math import rodrigues
    >>> rodrigues([1, 0, 0], 0)
    array([[1., 0., 0.],
           [0., 1., 0.],
           [0., 0., 1.]])
...
def rotation_distance(mat1, mat2):
    ...
    --------
    >>> import numpy
    >>> from magrobot.coordinates.math import rotation_distance
...
def quaternion_distance(q1, q2, absolute=False):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import quaternion_distance
...
def quaternion_absolute_distance(q1, q2):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import quaternion_absolute_distance
...
def quaternion_norm(q):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import quaternion_norm
    >>> q = [1, 1, 1, 1]
    >>> quaternion_norm(q)
    2.0
...
def quaternion_normalize(q):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import quaternion_normalize
    >>> from magrobot.coordinates.math import quaternion_norm
...
def quaternion_from_axis_angle(theta, axis):
    ...
    --------
    >>> import numpy
    >>> from magrobot.coordinates.math import quaternion_from_axis_angle
...
def axis_angle_from_quaternion(quat):
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import axis_angle_from_quaternion
...
def axis_angle_from_matrix(rotation):
    ...
    --------
    >>> import numpy
    >>> from magrobot.coordinates.math import axis_angle_from_matrix
...
def random_quaternion():
    ...
    Examples
    --------
    >>> from magrobot.coordinates.math import random_quaternion
    >>> random_quaternion()
