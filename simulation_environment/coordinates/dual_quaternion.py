...
class DualQuaternion(object):
    ...
    def quaternion(self):
        ...
        Returns
        -------
        dq.qr : magrobot.coordinates.quaternion.Quaternion
            rotation quaternion
        """
        dq = self.normalized
        return dq.qr
    ...
    def qr(self, qr_wxyz):
        ...
        qr_wxyz : list or numpy.ndarray or
                  magrobot.coordinates.quaternion.Quaternion
            new qr
        """
    ...
    def qd(self):
        ...
        Returns
        -------
        self._qd : magrobot.coordinates.quaternion.Quaternion
    ...
    def normalize(self):
        ...
        Returns
        -------
        self : magrobot.coordinates.dual_quaternion.DualQuaternion
            return self
        """
    ...
    def normalized(self):
        ...
        DualQuaternion(qr, qd, True) :
                magrobot.coordinates.dual_quaternion.DualQuaternion
    ...
    def interpolate(dq0, dq1, t):
        ...
        Parameters
        ----------
        dq0 : magrobot.coordinates.dual_quaternion.DualQuaternion
        dq1 : magrobot.coordinates.dual_quaternion.DualQuaternion
            dual quaternion
        t : float
    ...
    def axis(self):
        ...
        self.qr.axis : numpy.ndarray
            ...
            See See magrobot.coordinates.quaternion.Quaternion.axis.
        """
        return self.qr.axis
    ...
    def angle(self):
        ...
        self.qr.angle : float
            ...
            See magrobot.coordinates.quaternion.Quaternion.angle.
        """
    ...
    def inverse(self):
        ...
        Returns
        -------
        dq : magrobot.coordinates.dual_quaternion.DualQuaternion
    ...
    def difference_position(self, other_dq):
        ...
        Parameters
        ----------
        other_dq : magrobot.coordinates.dual_quaternion.DualQuaternion
            dual quaternion
